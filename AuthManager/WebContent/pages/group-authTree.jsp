...
<script type="text/javascript">
      ...
      /*   $(document).ready(function(){
        	$(".give-auth").click(function(){
        		...
        		var groupId = ${groupId } // 获取session中的groupId
        		alert(authIds +"::"+ isClick +"::"+ groupId);
        		...
        		$.ajax({
        			...
        			url:"${pageContext.request.contextPath}/group/updateUserGroupAuth.action",
	...
	<div class="container-fluid" style="margin-top: 30px;">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">部门权限列表</h1>
				<div class="row placeholders">
					<!-- <button type="button" class="btn btn-default give-auth" style="width:110px;">确认更改权限</button> -->
					<a href="${pageContext.request.contextPath}/group/list.action">
						<button type="button" style="width:110px;" class="btn btn-primary">返回部门列表</button>
					</a>
                    <!--  将选择后的authId存隐藏域中-->
