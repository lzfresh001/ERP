       ...
       var setting = {    
        ...
        $(document).ready(function(){
        	$(".give-auth").click(function(){
        		...
        		var userId = ${userId} // 获取session中的userId
        		//alert(authIds +"::"+ isClick +"::"+ userId);
        		...
        		$.ajax({
        			...
        			url:"${pageContext.request.contextPath}/user/updateUserAuth.action",
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders">
					...
					<a href="${pageContext.request.contextPath}/user/list.action">
						<button type="button" style="width:110px;" class="btn btn-primary">返回用户列表</button>
					</a>
                    <!--  将选择后的authId存隐藏域中-->
