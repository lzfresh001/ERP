...
/**
 * Servlet implementation class DeleteAddServlet
 */
public class DeleteAddServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		us.deleteAddressByU(uid, addd);
		
		out.println("<script>alert('数据已更新！！！');location.href='orange/orange/pay.jsp?pid="+pid+"';</script>");
