			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.jsp?id=17"><img src="../../image/lb1.jpg" /></a></li>
								<li class="banner2"><a href="introduction.jsp?id=1" ><img src="../../image/lb2.jpg" /></a></li>
								<li class="banner3"><a href="introduction.jsp?id=2" ><img src="../../image/lb3.jpg" /></a></li>
							    <li class="banner4"><a href="introduction.jsp?id=3"><img src="../../image/lb4.jpg" /></a></li>
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/nut.png"></i><a class="ml-22" title="点心">坚果/炒货</a></h3>
													<em>&gt;</em></div>
														...
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	...
																	%>
																		<dd><a title="蒸蛋糕" href="introduction.jsp?id=<%=nut.getId()%>"><span><%=nut.getName() %></span></a></dd>
																	<%
																		}
																	%>	
																	</dl>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/cake.png"></i><a class="ml-22" title="坚果、炒货">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed flood method3 " />
						<ul class="am-thumbnails ">
							<%
								...
								List<Nut> nutss = uss.findAllNut();
								for(int i=0;i<nutss.size();i++){
									Nut nut = nutss.get(i);
							%>
									<li onclick="location.href='introduction.jsp?id=<%=nut.getId() %>'">
										<div class="list ">
											<a href="# ">
												<img src="<%=nut.getSrc() %>" />
												<div class="pro-title "><%=nut.getName() %> <%=nut.getWeight() %>g/袋</div>
												<span class="e-price ">￥<%=nut.getPrice() %>0</span>
											</a>
										</div>
									</li>
							<% 
