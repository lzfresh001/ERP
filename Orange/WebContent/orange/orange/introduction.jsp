...
<body>
	...
	<div class="listMain">
		...
		<%
			...
			Nut nut = us.findNutById(id);
			session.setAttribute("page", "orange/orange/introduction.jsp?id=" + id);
		%>
		<div class="scoll">
			<section class="slider">
				<div class="flexslider">
					<ul class="slides">
						<li><img src="<%=nut.getSrc()%>" title="pic" /></li>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a><img src="<%=nut.getSrc()%>" alt="细节展示放大镜特效"
							rel="<%=nut.getSrc()%>" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a><img src="<%=nut.getSrc()%>" mid="<%=nut.getSrc()%>"
									big="<%=nut.getSrc()%>"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a><img src="<%=nut.getSrcc()%>" mid="<%=nut.getSrcc()%>"
									big="<%=nut.getSrcc()%>"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a><img src="<%=nut.getSrccc()%>" mid="<%=nut.getSrccc()%>"
									big="<%=nut.getSrccc()%>"></a>
							</div>
						</li>
					</ul>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price"><%=nut.getPrice()%>0</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice"><%=nut.getPrice()*2 %>0</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
									...
									<form class="theme-signin" name="loginform" action=""
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name="" type="button" value="-" />
														 ...
														 <span id="Stock" class="tb-hidden">库存<span class="stock"><%=nut.getCount() %></span>件
													</span>
												</dd>
											</div>
											<script>
												...
												function addShopcart(){
													location.href = "${pageContext.request.contextPath}/shopcart?id=" + <%=nut.getId()%> + "&num=" + text_box.value; 
												}
												function nowPay(){
													var pid = "<%=id %>";
													var id = "<%=id%>";
													
													location.href = "../../NowPay?PID=" + pid + "&ID=" + id + "&NUM=" + text_box.value;
												}
												function nowCollection(){
													var id = "<%=id%>";
													
													location.href = "../../NowCollection?ID=" + id;
												}
											</script>
											<div class="clear"></div>
											...
											<div class="btn-op">
												...
												<div class="btn close am-btn am-btn-warning"></div>
											</div>
										</div>
										<div class="theme-signin-right">
											...
											<div class="text-info">
												<span class="J_Price price-now"></span> <span id="Stock"
													class="tb-hidden"><span class="stock"></span>件 </span>
											</div>
										</div>
										<br />
										<li>
											<div class="clearfix tb-btn tb-btn-buy theme-login"  >
												<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="nowPay()" ><i></i>立即购买</a>
											</div>
										</li>
										<li>
											<div class="clearfix tb-btn tb-btn-basket theme-login">
												<a id="LikBasket" title="加入购物车" onclick="addShopcart()" ><i></i>加入购物车</a>
											</div>
										</li>
										<li>
											<div class="clearfix tb-btn tb-btn-buy theme-login"  >
												<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="nowCollection()" ><i></i>立即收藏</a>
											</div>
										</li>
					...
					<div class="am-tabs-bd">
						...
						<div class="am-tab-panel am-fade am-in am-active">
							<div class="J_Brand">
								...
								<div class="clear"></div>
								<ul id="J_AttrUL">
									<li title="">品名:&nbsp;<%=nut.getName()%></li>
									<li title="">净含量:&nbsp;<%=nut.getWeight()%>g
									</li>
									<li title=""></li>
									<li title="">保质期:&nbsp;<%=nut.getExdate()%>天
									</li>
									<li title="">生产日期:&nbsp;<%=nut.getDate()%></li>
									<li title=""></li>
									<li title="">品牌:&nbsp;<%=nut.getBrand()%></li>
									<li title="">生产许可证编号：&nbsp;<%=nut.getPlno()%></li>
									<li title=""></li>
									<li title="">产地：&nbsp;<%=nut.getPlace()%></li>
								</ul>
								<div class="clear"></div>
							</div>
							...
							<div class="details">
								...
								<div class="twlistNews">
									<img src="<%=nut.getSrca()%>" /> <img src="<%=nut.getSrcb()%>" />
									<img src="<%=nut.getSrcd()%>" /> <img src="../images/tw4.jpg" />
									<img src="../images/tw5.jpg" /> <img src="../images/tw7.jpg" />
