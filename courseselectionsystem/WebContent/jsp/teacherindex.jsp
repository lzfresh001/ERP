...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		<div class="logo margin-big-left fadein-top">
			<h1>
				<img src="images/lao.jpg" class="radius-circle rotate-hover"
					height="50" alt="" />${TEAC.tname } ,您好！
			</h1>
		</div>
		<div class="head-l">
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			...
			<li><a href="teacherinfo.jsp" target="right"><span
					class="icon-caret-right"></span>个人信息</a></li>
			<li><a href="teacherbook.jsp" target="right"><span
					class="icon-caret-right"></span>所代课程</a></li>
			<li><a href="${pageContext.request.contextPath }/giveScore.action?order=no&tid=${TEAC.tid }&pageNum=1" target="right"><span
					class="icon-caret-right"></span>课程打分</a></li>
			<li><a href="teacherpass.jsp" target="right"><span
