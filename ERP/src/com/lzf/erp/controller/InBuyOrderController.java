...
public class InBuyOrderController {
	...
	public void queryInBuyOrderForStatistics(@RequestParam(value="inboname",required=false)String inboname,
											 @RequestParam(value="businame",required=false)String businame,
											 @RequestParam(value="beginDate",required=false)String beginDate,
											 @RequestParam(value="endDate",required=false)String endDate,
											 HttpServletResponse response) throws Exception {
		Map<String,Object> map = new HashMap<String,Object>();
		if(StringUtil.isNotEmpty(inboname)) {
			map.put("inboname", inboname);
		}
		...
		JSONArray jsonArray = inBuyOrderService.queryInBuyOrderForStatistics(map);
